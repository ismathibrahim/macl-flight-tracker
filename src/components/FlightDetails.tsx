    ...
    <Drawer.Root open={isOpen} onOpenChange={onOpenChange}>
      <Drawer.Portal>
        ...
        <Drawer.Content
          ...
          aria-describedby="Flight Details"
          aria-description={flight.flightNumber}
          className="bg-bg-base h-fit fixed bottom-0 left-0 right-0 outline-none rounded-t-6xl"
        >
          <VisuallyHidden.Root>
            <Dialog.Title className="text-text-base font-medium">
              Flight Details
            </Dialog.Title>
            <Dialog.Description className="text-text-subtle">
              {flight.flightNumber}
            </Dialog.Description>
          </VisuallyHidden.Root>
          <div className="max-w-lg mx-auto px-4 pb-5">
            ...
            <div className="flex gap-2 justify-between items-center border-t border-border-strong mt-5 pt-5 border-dashed">
              <div className="w-2/5">
                <p className="text-text-subtle text-sm flex gap-1 items-center">
                  <AirplaneTakeoff /> Departure
                </p>
              ...
              <div className="w-2/5 text-right">
                <p className="text-text-subtle text-sm flex gap-1 items-center justify-end">
                  <AirplaneLanding /> Arrival
                </p>
                <p className="text-text-base font-medium">
                  {flight.direction === "arrival"
                    ? "Velana Int. Airport"
            ...
            <div className="flex gap-2 border-t border-border-strong mt-5 pt-5 border-dashed">
              <div className="flex gap-1">
                <p className="text-text-subtle">
                  {flight.direction === "arrival" ? "Baggage Claim" : "Gate"}:{" "}
                </p>
                <p className="text-text-base font-medium">
                  {flight.direction === "arrival"
                    ? flight.baggageClaim
